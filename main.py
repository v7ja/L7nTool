...
def Lev ():
	...
	while True:
	   user = str("".join(random.choice(a)for x in range(1)))
	   user1 = str("".join(random.choice(a)for x in range(1)))
	   user2 = str("".join(random.choice(a)for x in range(1)))
	   user3 = str("".join(random.choice(a)for x in range(1)))
	   user5 = (user1+user2+'.'+user3)
	   user6 = (user+user2+'_'+user3)
	   user7 = (user1+user+'.'+user3)
	   user8 = (user3+user1+'_'+user)
				user9 = (user1+user+user2+user3)
				user10 = (user+user1+user2+user3)
				user11 = ('.'+user1+user2+'_')
				user12 = (user1+'.'+user3+user2)
	   abd= (user5, user6, user7, user8, user9, user10, user11, user12,)
